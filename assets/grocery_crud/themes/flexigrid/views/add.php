...
?>
		...
		<div class="pDiv">
			...
			<div class='form-button-box'>
				<input type='button' class="btn btn-large btn-success" value='<?php echo $this->l('form_save_and_go_back'); ?>' id="save-and-go-back-button"  class="btn btn-large"/>
			</div>
			<div class='form-button-box'>
				<input type='button' value='<?php echo $this->l('form_cancel'); ?>' class="btn btn-large btn-primary" id="cancel-button" />
			</div>
			<?php 	} ?>
			<div class='form-button-box'>
